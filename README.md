...
Once inside the container, run the app with two terminals:
...
Make sure you have installed [.NET 10](https://get.dot.net), [Node.js LTS](https://nodejs.org/), [pnpm](https://pnpm.io/) and set the required environment variables.

## Sources

- [WebApi](https://docs.microsoft.com/en-us/aspnet/core/tutorials/first-web-api?view=aspnetcore-6.0&tabs=visual-studio-code)
- [EF Core](https://docs.microsoft.com/en-us/ef/core/)
- [Lazy loading with proxies](https://docs.microsoft.com/en-us/ef/core/querying/related-data/lazy)
- [Model Binding](https://docs.microsoft.com/en-us/aspnet/core/mvc/models/model-binding?view=aspnetcore-6.0)
